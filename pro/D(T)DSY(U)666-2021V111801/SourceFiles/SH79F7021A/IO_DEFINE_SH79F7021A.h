...
*/
#define GPIO_IOCFG_P0_DIR_O(X)		( P0CR |= GPIO_BIT(X) )			// 配置成输出
#define GPIO_IOCFG_P0_DIR_I(X)		( P0CR &= GPIO_BIT_(X)) 		// 配置成输输入

#define GPIO_IOCFG_P1_DIR_O(X)		( P1CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P1_DIR_I(X)		( P1CR &= GPIO_BIT_(X) )		// 

#define GPIO_IOCFG_P2_DIR_O(X)		( P2CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P2_DIR_I(X)		( P2CR &= GPIO_BIT_(X) )		// 

#define GPIO_IOCFG_P3_DIR_O(X)		( P3CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P3_DIR_I(X)		( P3CR &= GPIO_BIT_(X) )		// 

#define GPIO_IOCFG_P4_DIR_O(X)		( P4CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P4_DIR_I(X)		( P4CR &= GPIO_BIT_(X)  )		// 

#define GPIO_IOCFG_P5_DIR_O(X)		( P5CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P5_DIR_I(X)		( P5CR &= GPIO_BIT_(X)  )		// 

#define GPIO_IOCFG_P6_DIR_O(X)		( P6CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P6_DIR_I(X)		( P6CR &= GPIO_BIT_(X)  )		// 

#define GPIO_IOCFG_P7_DIR_O(X)		( P7CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P7_DIR_I(X)		( P7CR &= GPIO_BIT_(X)  )		// 

#define GPIO_IOCFG_P8_DIR_O(X)		( P8CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P8_DIR_I(X)		( P8CR &= GPIO_BIT_(X)  )		// 

#define GPIO_IOCFG_P9_DIR_O(X)		( P9CR |= GPIO_BIT(X)  )		// 
#define GPIO_IOCFG_P9_DIR_I(X)		( P9CR &= GPIO_BIT_(X)  )		// 
...
* @brief P9口 总共8根口线 p9.0/1/2/3/4/5/6/7
*/
#define GPIO_IOCFG_P0_PUP_O(X)		( P0PCR |= GPIO_BIT(X)  )		// 开启 on
#define GPIO_IOCFG_P0_PUP_F(X)		( P0PCR &= GPIO_BIT_(X)  )		// 关闭 off
#define GPIO_IOCFG_P1_PUP_O(X)		( P1PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P1_PUP_F(X)		( P1PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P2_PUP_O(X)		( P2PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P2_PUP_F(X)		( P2PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P3_PUP_O(X)		( P3PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P3_PUP_F(X)		( P3PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P4_PUP_O(X)		( P4PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P4_PUP_F(X)		( P4PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P5_PUP_O(X)		( P5PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P5_PUP_F(X)		( P5PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P6_PUP_O(X)		( P6PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P6_PUP_F(X)		( P6PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P7_PUP_O(X)		( P7PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P7_PUP_F(X)		( P7PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P8_PUP_O(X)		( P8PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P8_PUP_F(X)		( P8PCR &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P9_PUP_O(X)		( P9PCR |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P9_PUP_F(X)		( P9PCR &= GPIO_BIT_(X)  )		//
...
* @brief  1:H
*/
#define GPIO_IOCFG_P0_STAT_H(X)		( (P0 & GPIO_BIT(X)) == GPIO_BIT(X) )
#define GPIO_IOCFG_P0_STAT_L(X)		( (P0 & GPIO_BIT(X)) != GPIO_BIT(X) )
...
*/
#define GPIO_IOCFG_P0_OUT_C(X)		( P0OS |= GPIO_BIT(X)  )		// 引脚输出模式为CMOS挽推输出
#define GPIO_IOCFG_P0_OUT_N(X)		( P0OS &= GPIO_BIT_(X)  )		// 引脚输出模式为N沟道开漏输出（复位值）
#define GPIO_IOCFG_P2_OUT_C(X)		( P2OS |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P2_OUT_N(X)		( P2OS &= GPIO_BIT_(X)  )		//
#define GPIO_IOCFG_P3_OUT_C(X)		( P3OS |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P3_OUT_N(X)		( P3OS &= GPIO_BIT_(X)  )		//
...
// 端口输出高能力减弱模式选择
//P0/P2
#define GPIO_IOCFG_P0_OUTH_NORMAL(X)		( P0DRVH |= GPIO_BIT(X)  )		// 引脚输出模式减弱高电平
#define GPIO_IOCFG_P0_OUTH_WEAKEN(X)		( P0DRVH &= GPIO_BIT_(X)  )		// 引脚输出模式正常高电平 复位值0
#define GPIO_IOCFG_P2_OUTH_NORMAL(X)		( P2DRVH |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P2_OUTH_WEAKEN(X)		( P2DRVH &= GPIO_BIT_(X)  )		//
...
//P1
#define GPIO_IOCFG_P1_OUTL_NORMAL(X)		( P1DRVL |= GPIO_BIT(X)  )		//引脚输出模式减弱低电平 
#define GPIO_IOCFG_P1_OUTL_WEAKEN(X)		( P1DRVL &= GPIO_BIT_(X)  )		//引脚输出模式正常低电平 复位值0
...
*/          
#define GPIO_IOCFG_P0_PUPM_NORMAL(X)		( P0PHM |= GPIO_BIT(X)  )		// 引脚输入上拉切换模式
#define GPIO_IOCFG_P0_PUPM_SWITCH(X)		( P0PHM &= GPIO_BIT_(X)  )		// 引脚输入上拉正常模式 复位值0
#define GPIO_IOCFG_P2_PUPM_NORMAL(X)		( P2PHM |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P2_PUPM_SWITCH(X)		( P2PHM &= GPIO_BIT_(X)  )		//
...
*/ 
#define GPIO_IOCFG_P0_INM_LEVEL(X)		( P0INM |= GPIO_BIT(X)  )		// 输出状态下， 读取PORT寄存器时， 返回PORT 口电平  
#define GPIO_IOCFG_P0_INM_DATA(X)		( P0INM &= GPIO_BIT_(X)  )		// 输出状态下， 读取PORT寄存器时， 返回PORT数据寄存器值 复位值0
#define GPIO_IOCFG_P2_INM_LEVEL(X)		( P2INM |= GPIO_BIT(X)  )		//
#define GPIO_IOCFG_P2_INM_DATA(X)		( P2INM &= GPIO_BIT_(X)  )		//
