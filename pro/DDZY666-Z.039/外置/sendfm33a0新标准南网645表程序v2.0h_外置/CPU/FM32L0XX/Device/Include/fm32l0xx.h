...
typedef enum {
	...
	UART3_num = 17,	UART4_num = 18,	UART5_num = 19,	USART0_num = 20,	USART1_num = 21,	
...
/* ---------------------  FM32L0XX Specific Interrupt Numbers  -------------------- */
  ...
  USART0_IRQn                   =  15,              /*!<  15   USART0_IRQn          */
  USART1_IRQn                   =  16,              /*!<  16   USART1_IRQn	          */
...
#include "system_FM32L0XX.h"                        /*!< FM32L0XX System                                                       */
...
typedef struct 
{
  ...
  __IO 	uint32_t 	UARTIF;                         /*!< UART interrupt flag */
	__IO 	uint32_t	TZBRG;													/*!< UART infrared control */
} Uart_common_Type;
...
typedef struct
{
  ...
  __IO uint32_t LDO15CON;  				/*!< ANAC LDO15CON CONFIG REGISTER,  			Address offset: 0x08 */
	...
	__IO uint32_t TROSCCR;					/*!< ANAC TEST OSC CONTROL REGISTER,			Address offset: 0x50 */
} ANAC_Type;
...
#define USART0_BASE					(PERIPH_BASE				+0x00011C00)	
#define USART1_BASE					(PERIPH_BASE				+0x00011C2C)	
...
#define HSPI														((SPI_Type            		*) HSPI_BASE				)
...
#include "fm32l0xx_uart.h"
#include "fm32l0xx_rcc.h"
#include "fm32l0xx_gpio.h"
#include "fm32l0xx_iwdg.h"
#include "fm32l0xx_nvmif.h"
#include "fm32l0xx_dma.h"
#include "fm32l0xx_spi.h"
//#include "fm32l0xx_etimer.h"
//#include "fm32l0xx_lptim.h"
#include "fm32l0xx_btim.h"
#include "fm32l0xx_scu.h"
#include "fm32l0xx_i2c.h"
//#include "fm32l0xx_wwdt.h"
#include "fm32l0xx_anac.h"
//#include "fm32l0xx_u7816.h"
#include "fm32l0xx_rtc.h"
//#include "fm32l0xx_crc.h"
//#include "fm32l0xx_disp.h"
