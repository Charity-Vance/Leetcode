...
#define ANAC_SVDCFG_PRIE_PFIE_ENABLE     								  ((uint32_t)0x00000300) 
...
//****SVDALM *****//
#define ANAC_SVDALM_SVDALM_B_DISABLE										((uint32_t)0x00000000)
#define ANAC_SVDALM_SVDALM_B_ENABLE										((uint32_t)0x00000001)
/**
* @}ANAC_FDETIF
*/ 
