...
#define C_3DESKey2_Offset				0x08			/*3DES密钥key2地址偏移*/
#define C_3DESKey3_Offset				0x10			/*3DES密钥key3地址偏移*/
#define C_FixedData_Offset				0x18			/*验证中固定数据的地址偏移*/
#define C_EnterBootFlag_Offset			0x20			/*进入BootLoader标志的地址偏移*/
#define C_Software_Featurcode_Offset	0x30			/*软件版本标识*/
#define C_Software_Version_Offset		0x50			/*软件版本号*/
#define C_Hardware_Version_Offset		0x70			/*硬件版本号*/


#define C_3DES_KeyLen	8
#define C_3DES_DataLen	8
#define C_EnterBootFlag_Len				0x10			/*软件版本标识*/
#define C_External_Version_Len			(0x200 - C_Software_Featurcode_Offset)
#define C_FeaturCode_Len				30
